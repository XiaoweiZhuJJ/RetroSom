...
my $nov_file  = $path.'/'.$retro.'/'.$TE.'/'.$sub.'.'.$TE.'.noref.calls';
my $over_file = $path.'/'.$retro.'/'.$TE.'/'.$sub.'.'.$TE.'.over.calls';
my $out_file  = $path.'/'.$retro.'/'.$TE.'/'.$sub.'.'.$TE.'.overlap.txt';
my $pe_file   = $path.'/'.$retro.'/'.$TE.'/'.$sub.'.'.$TE.'.novel.sites';
my $sr_file   = $path.'/'.$retro.'/'.$sub.'.sr.tabe.discover';
