...
my $sr_file    = $ARGV[1].'/'.$ARGV[2].'/'.$ARGV[0].'_Brain.'.$ARGV[3].'.sr.tabe.discover';
my $ou_file    = $ARGV[1].'/'.$ARGV[2].'/'.$ARGV[0].'_Brain.'.$ARGV[3].'.sr.dedup.discover';
my $dup_file   = $ARGV[1].'/'.$ARGV[2].'/'.$ARGV[0].'_Brain.'.$ARGV[3].'.sr.dup.txt';
my $clust_file = $ARGV[1].'/'.$ARGV[2].'/'.$ARGV[0].'_Brain.'.$ARGV[3].'.sr.cluster.txt';
