...
my $r1_file   = $path.'/'.$sub.'/'.$retro.'/'.$TE.'/'.$sub.'.retro_v'.$ARGV[0].'.read1.fa';
my $r2_file   = $path.'/'.$sub.'/'.$retro.'/'.$TE.'/'.$sub.'.retro_v'.$ARGV[0].'.read2.fa';
my $align_file= $path.'/'.$sub.'/'.$retro.'/'.$TE.'/'.$sub.'.retro_v'.$ARGV[0].'.align.temp';
