...
usage="$(basename "$0") [-h] [-o i m r g s] -- Create feature matrix for the L1 PE supporting reads. Requires one core, and 8gb memory
...
$masterpath/LINE/01_PE_matrix/01_L1PE_matrix.pl $outpath $sub $ver $strand $hg $masterpath
