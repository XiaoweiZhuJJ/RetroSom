...
### L1HS ###
awk -v c1=$cord1 -v c2=$cord2 -v c3=$cord3 '{if ($8>85 && $11<c1 && $12>=c3 && ($4 == "L1HS")) {split($13, str, ""); print $0"\t+\t"str[c1-$11]str[c2-$11]str[c3-$11];}}' \
   $datapath/$Retro/$sub.alleles.discover \
   > $datapath/$Retro/$sub.L1HS.discover

awk -v c1=$cord1 -v c2=$cord2 -v c3=$cord3 '{if ($8>85 && $11>=c3 && $12<c1 && ($4 == "L1HS")) {split($13, str, ""); print $0"\t-\t"str[$11-c3-1]str[$11-c2-1]str[$11-c1-1];}}' \
   $datapath/$Retro/$sub.alleles.discover \
   >> $datapath/$Retro/$sub.L1HS.discover

awk -v c1=$cord1 -v c2=$cord2 -v c3=$cord3 '{if ($9>85 && $14<c1 && $15>=c3 && ($4 == "L1HS")) {split($17, str, ""); print $0"\t+\t"str[c1-$14]str[c2-$14]str[c3-$14];}}' \
   $datapath/$Retro/$sub.sr.alleles.discover \
   > $datapath/$Retro/$sub.sr.L1HS.discover

awk -v c1=$cord1 -v c2=$cord2 -v c3=$cord3 '{if ($9>85 && $14>=c3 && $15<c1 && ($4 == "L1HS")) {split($17, str, ""); print $0"\t-\t"str[$14-c3-1]str[$14-c2-1]str[$14-c1-1];}}' \
   $datapath/$Retro/$sub.sr.alleles.discover \
   >> $datapath/$Retro/$sub.sr.L1HS.discover
...
$masterpath/LINE/00_remap/02_realign.L1HS.pl $sub $Retro $datapath $geno $cord1 $cord3
