...
my $m1_file  = $workfolder.'/'.$sample.'/'.$retro.'_0/'.$sample.'.sr.LINE.matrix';
my $m2_file  = $workfolder.'/'.$sample.'/'.$retro.'_1/'.$sample.'.sr.LINE.matrix';
my $g1_file  = $workfolder.'/'.$sample.'/'.$retro.'_1/LINE/'.$sample.'.sr.pred.G1.txt';
my $g2_file  = $workfolder.'/'.$sample.'/'.$retro.'_1/LINE/'.$sample.'.sr.pred.G2.txt';
my $ou1_file = $workfolder.'/'.$sample.'/'.$retro.'_0/LINE/'.$sample.'.sr2.pred.all.txt';
my $ou2_file = $workfolder.'/'.$sample.'/'.$retro.'_0/LINE/'.$sample.'.sr2.pred.summary';
my $ou3_file = $workfolder.'/'.$sample.'/'.$retro.'_1/LINE/'.$sample.'.sr2.pred.all.txt';
my $ou4_file = $workfolder.'/'.$sample.'/'.$retro.'_1/LINE/'.$sample.'.sr2.pred.summary';
my @order = (1,2); 
my ($line, @data);
my (%pred1, %pred2);
